...
import { A as AstroError, U as UnknownContentCollectionError, c as createComponent, R as RenderUndefinedEntryError, u as unescapeHTML, r as renderTemplate, i as AstroUserError, j as renderUniqueStylesheet, k as renderScriptElement, l as createHeadAndContent, d as renderComponent } from './astro/server_CzyFbPgW.mjs';
import 'kleur/colors';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_DuB_8ZOv.mjs');
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "SITE": "https://ntibusinessconsulting.netlify.com", "SSR": true};
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_CYB1M3sc.mjs');
...
export { CONTENT_LAYER_TYPE as C, DEFAULT_HASH_PROPS as D, getEntries as a, reference as b, getEntry as c, defineCollection as d, getCollection as g, renderEntry as r };
